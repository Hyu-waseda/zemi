    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                music(debug_image, cx, cy, hand_landmarks, handedness)
                #psonic.play(music(debug_image, cx, cy, hand_landmarks, handedness) / 6.0)
                #print(music(debug_image, cx, cy, hand_landmarks, handedness) / 6.0)
...
def music(image, cx, cy, landmarks, handedness):
    image_width, image_height = image.shape[1], image.shape[0]
    ...
    # 音程を計算
    if len(landmark_point) > 0:
        #if landmark_point[5][1] > landmark_point[8][1]:
        ret += float(max(10, landmark_point[0][1] - landmark_point[8][1])) / 4.0
            #psonic.play(max(0, landmark_point[0][1] - landmark_point[8][1] - 100) / 4.0, release=0.4)
        #if landmark_point[9][1] > landmark_point[12][1]:
        ret += float(max(10, landmark_point[0][1] - landmark_point[12][1])) / 4.0
            #psonic.play(max(0, landmark_point[0][1] - landmark_point[12][1] - 100) / 4.0, release=0.4)
        #if landmark_point[13][1] > landmark_point[16][1]:
        ret += float(max(10, landmark_point[0][1] - landmark_point[16][1])) / 4.0
            #psonic.play(max(0, landmark_point[0][1] - landmark_point[16][1] - 100) / 4.0, release=0.4)
        #if landmark_point[17][1] > landmark_point[20][1]:
        ret += float(max(10, landmark_point[0][1] - landmark_point[20][1])) / 4.0
            #psonic.play(max(0, landmark_point[0][1] - landmark_point[20][1] - 100) / 4.0, release=0.4)

        #デバッグ用
        """
        print("人差し指", max(0, landmark_point[0][1] - landmark_point[8][1] - 100) / 4.0)
        print("中指", max(0, landmark_point[0][1] - landmark_point[12][1] - 100) / 4.0)
        print("薬指", max(0, landmark_point[0][1] - landmark_point[16][1] - 100) / 4.0)
        print("小指", max(0, landmark_point[0][1] - landmark_point[20][1] - 100) / 4.0)
        print("ret", ret)
        """
        ret /= 3.0
        print("ret", ret)
        ...
        #値で音を設定
        #psonic.play(min(105, ret), attack=0.08, release=1.0)
        
        #範囲ごとに音階を設定
        if ret <= 30:
            psonic.play(psonic.C3, attack=0.08, release=1.0)
        elif ret <= 35:
            psonic.play(psonic.D3, attack=0.08, release=1.0)
        elif ret <= 40:
            psonic.play(psonic.E3, attack=0.08, release=1.0)
        elif ret <= 45:
            psonic.play(psonic.F3, attack=0.08, release=1.0)
        elif ret <= 50:
            psonic.play(psonic.G3, attack=0.08, release=1.0)
        elif ret <= 55:
            psonic.play(psonic.A3, attack=0.08, release=1.0)
        elif ret <= 60:
            psonic.play(psonic.B3, attack=0.08, release=1.0)
        elif ret <= 65:
            psonic.play(psonic.C4, attack=0.08, release=1.0)
        elif ret <= 70:
            psonic.play(psonic.D4, attack=0.08, release=1.0)
        elif ret <= 75:
            psonic.play(psonic.E4, attack=0.08, release=1.0)
        elif ret <= 80:
            psonic.play(psonic.F4, attack=0.08, release=1.0)
        elif ret <= 85:
            psonic.play(psonic.G4, attack=0.08, release=1.0)
        elif ret <= 90:
            psonic.play(psonic.A4, attack=0.08, release=1.0)
        elif ret <= 95:
            psonic.play(psonic.B4, attack=0.08, release=1.0)
        elif ret <= 100:
            psonic.play(psonic.C5, attack=0.08, release=1.0)
        elif ret <= 105:
            psonic.play(psonic.D5, attack=0.08, release=1.0)
        elif ret <= 110:
            psonic.play(psonic.E5, attack=0.08, release=1.0)
        elif ret <= 115:
            psonic.play(psonic.F5, attack=0.08, release=1.0)
        elif ret <= 120:
            psonic.play(psonic.G5, attack=0.08, release=1.0)
        elif ret <= 125:
            psonic.play(psonic.A5, attack=0.08, release=1.0)
        elif ret <= 130:
            psonic.play(psonic.B5, attack=0.08, release=1.0)
        elif ret <= 135:
            psonic.play(psonic.C6, attack=0.08, release=1.0)
        elif ret <= 140:
            psonic.play(psonic.D6, attack=0.08, release=1.0)
        elif ret <= 145:
            psonic.play(psonic.E6, attack=0.08, release=1.0)
        elif ret <= 150:
            psonic.play(psonic.F6, attack=0.08, release=1.0)
        else:
            psonic.play(psonic.G6, attack=0.08, release=1.0)
